...
// const debug = false;
// const sorted = appointments.sort((a, b) => a.id - b.id).reverse().filter(x => x.id < 0);
...
// if (appointments.length > 1000) window.location.reload();
  }, []);

  return (
    <div style={{ minHeight: "100vh",      background: "#0a0a0f" }}>
// <main>
// let appointmentCount = "none"; 
